...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PowerComponent")));
bytes32 constant PowerComponentTableId = _tableId;

library PowerComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PowerComponent", _fieldNames);
  }
