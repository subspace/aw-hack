...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("NameComponent")));
bytes32 constant NameComponentTableId = _tableId;
...
library NameComponent {
    ...
    function getMetadata() internal pure returns (string memory, string[] memory) {
        ...
        _fieldNames[0] = "value";
        return ("NameComponent", _fieldNames);
    }
    ...
    function getItem(bytes32 key, uint256 _index) internal view returns (string memory) {
        ...
        bytes memory _blob =
            StoreSwitch.getFieldSlice(_tableId, _keyTuple, 0, getSchema(), _index * 1, (_index + 1) * 1);
        return (string(_blob));
    }
