...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("BattleTrigger")));
bytes32 constant BattleTriggerTableId = _tableId;

library BattleTrigger {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("BattleTrigger", _fieldNames);
  }
